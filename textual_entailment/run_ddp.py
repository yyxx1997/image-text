...
pid = os.getpid()
print("pid is {} local_rank is {}".format(pid, args.local_rank))
local_rank = args.local_rank
n_gpus = args.n_gpus
dist.init_process_group(backend="nccl", world_size=n_gpus, rank=local_rank)
rank = dist.get_rank()
print("pid is {} rank is {}".format(pid, rank))
...
for epoch in range(1, num_epoch + 1):
    ...
    if local_rank==0:
        ...
        if epoch % check_step == 0:
            ...
            torch.save(save_obj, checkpoints_dirname + '/checkpoint-{}.pth'.format(epoch))  
